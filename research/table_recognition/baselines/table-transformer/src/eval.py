...
def visualize(args, target, pred_logits, pred_bboxes):
    ...
    if args.data_type == 'structure' and args.table_words_dir:
...
def evaluate(args, model, criterion, postprocessors, data_loader, base_ds, device):
    ...
    model.eval()
    criterion.eval()
    run_tsr_metrics = args.data_type == "structure" and bool(args.table_words_dir)
    ...
    if run_tsr_metrics:
        ...
        print("Skipping TSR cell metrics because --table_words_dir was not provided.")
