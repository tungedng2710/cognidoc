import { ArrowLeft, BookOpenText, Braces, Download, KeyRound, UploadCloud } from "lucide-react";
        ...
        <section className="relative overflow-hidden rounded-[2rem] bg-slate-950 px-7 py-8 text-white shadow-2xl shadow-slate-950/15 sm:px-10">
          ...
          <div className="relative max-w-4xl">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
              Authenticate, create a repository, upload or pull a Hugging Face-compatible folder, publish an immutable revision, and query its preview through the REST API.
            </p>
